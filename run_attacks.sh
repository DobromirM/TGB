...
'EvolutionaryAttack(attack_dataset="train",rate=0.3,mutation_rate=0.25,mutation_range=100)'
...
for a in "${attack[@]}"
do
   python examples/linkproppred/tgbl-coin/dyrep.py --seed 1 --reduce_ratio 0.1 --attack $a
done